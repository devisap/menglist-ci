...
<head>
	<base href="">
	<title>Menglist - Task Management</title>
	<meta name="description" content="Save your task by using single tool for different amazing and great useful management" />
	<meta name="keywords" content=" Task Management" />
	<meta name="viewport" content="width=device-width, initial-scale=1" />
	<meta charset="utf-8" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Manage Your Task Manage Your Life" />
...
<body id="kt_body" data-bs-spy="scroll" data-bs-target="#kt_landing_menu" data-bs-offset="200" class="bg-white position-relative">
	...
	<div class="d-flex flex-column flex-root">
		...
		<div class="mb-0" id="home">
			<!--begin::Wrapper-->
			<div class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom landing-dark-bg" style="background-image: url(assets/media/svg/landing.svg)">
				<!--begin::Header-->
				...
				<div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9">
					...
					<div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
						<!--begin::Title-->
						<h1 class="text-white lh-base fw-bolder fs-2x fs-lg-3x mb-15">The Best Way to Organize your Task
							<br />with
							<span style="background: linear-gradient(to right, #12CE5D 0%, #FFD80C 100%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">
								<span id="kt_landing_hero_text">The Great Management Tools</span>
							</span>
						</h1>
						<!--end::Title-->
						<!--begin::Action-->
		...
		<div class="mb-n10 mb-lg-n20 z-index-2">
			...
			<div class="container">
				...
				<div class="text-center mb-17">
					...
					<!--end::Title-->
					<!--begin::Text-->
					<div class="fs-5 text-muted fw-bold">Save your task by using single tool
						<br />for different amazing and great useful management
					</div>
					<!--end::Text-->
				</div>
				<!--end::Heading-->
					...
					<div class="col-md-4 px-5">
						...
						<div class="text-center mb-10 mb-md-0">
							...
							<div class="d-flex flex-center mb-5">
								...
								<!--end::Badge-->
								<!--begin::Title-->
								<div class="fs-5 fs-lg-3 fw-bolder text-dark">Task Reminder</div>
								<!--end::Title-->
							</div>
							<!--end::Heading-->
							<!--begin::Description-->
							<div class="fw-bold fs-6 fs-lg-4 text-muted">We have a feature to remind
								<br />deadlines priority tasks.
							</div>
							<!--end::Description-->
						</div>
						<!--end::Story-->
					...
					<div class="col-md-4 px-5">
						...
						<div class="text-center mb-10 mb-md-0">
							...
							<div class="d-flex flex-center mb-5">
								...
								<!--end::Badge-->
								<!--begin::Title-->
								<div class="fs-5 fs-lg-3 fw-bolder text-dark">Task Priority</div>
								<!--end::Title-->
							</div>
							<!--end::Heading-->
							<!--begin::Description-->
							<div class="fw-bold fs-6 fs-lg-4 text-muted">We also provide a task order feature
								<br />according to priority.
							</div>
							<!--end::Description-->
						</div>
						<!--end::Story-->
					...
					<div class="col-md-4 px-5">
						...
						<div class="text-center mb-10 mb-md-0">
							...
							<div class="d-flex flex-center mb-5">
								...
								<!--end::Badge-->
								<!--begin::Title-->
								<div class="fs-5 fs-lg-3 fw-bolder text-dark">Halfpenny</div>
								<!--end::Title-->
							</div>
							<!--end::Heading-->
							<!--begin::Description-->
							<div class="fw-bold fs-6 fs-lg-4 text-muted">We provide economical packages
								<br />for those of you who are still in
								<br />school or workers.
							</div>
							<!--end::Description-->
						</div>
						<!--end::Story-->
		...
		<div class="mt-sm-n10">
			...
			<div class="pb-15 pt-18 landing-dark-bg">
				...
				<div class="container">
					<!--begin::Plans-->
					<div class="d-flex flex-column container pt-lg-20 mt-15 mb-18">
						<!--begin::Heading-->
									...
									<div class="d-flex h-100 align-items-center">
										...
										<div class="w-100 d-flex flex-column flex-center rounded-3 bg-body py-15 px-10">
											...
											<div class="mb-7 text-center">
												...
												<!--end::Title-->
												<!--begin::Description-->
												<div class="text-gray-400 fw-bold mb-5">Best Settings for Basic</div>
												<!--end::Description-->
												<!--begin::Price-->
		...
		<div class="mt-20 mb-n20 position-relative z-index-2">
			...
			<div class="container">
				...
				<div class="d-flex flex-stack flex-wrap flex-md-nowrap card-rounded shadow p-8 p-lg-12 mb-n5 mb-lg-n13" style="background: linear-gradient(90deg, #20AA3E 0%, #03A588 100%);">
					...
					<div class="my-2 me-5">
						<!--begin::Title-->
						<div class="fs-1 fs-lg-2qx fw-bolder text-white mb-2">Start With Menglist Today,
							<span class="fw-normal">Organize your Task!</span>
						</div>
						<!--end::Title-->
						<!--begin::Description-->
						<div class="fs-6 fs-lg-5 text-white fw-bold opacity-75">Faster and Easier Task Management Start Here</div>
						<!--end::Description-->
					</div>
					<!--end::Content-->
					<!--begin::Link-->
					<a href="#pricing" class="btn btn-lg btn-outline border-2 btn-outline-white flex-shrink-0 my-2">Purchase Now</a>
					<!--end::Link-->
				</div>
				<!--end::Highlight-->
			</div>
					...
					<div class="row py-10 py-lg-20">
						...
						<div class="col-lg-6 pe-lg-16 mb-10 mb-lg-0">
							...
							<div class="rounded landing-dark-border p-9 mb-10">
								<!--begin::Title-->
								<h2 class="text-white">Would you need a question ?</h2>
								<!--end::Title-->
								<!--begin::Text-->
						...
						<div class="col-lg-6 ps-lg-16">
							...
							<div class="d-flex justify-content-center">
								...
								<div class="d-flex fw-bold flex-column me-20">
									<!--begin::Subtitle-->
									<h4 class="fw-bolder text-gray-400 mb-6">More for Menglist</h4>
									<!--end::Subtitle-->
									<!--begin::Link-->
