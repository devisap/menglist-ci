<!DOCTYPE html>
  <html lang="en">
    <head>
      ...
      <link rel="icon" type="image/x-icon" href="http://api.elements.buildwithangga.com/storage/files/2/assets/Header/Header2/Header-2-2.png" />
      ...
      <div>
        <div class="mx-auto d-flex flex-lg-row flex-column hero">
          ...
          <div
            ...
            <p class="text-caption">TASK MANAGEMENT</p>
            <h1 class="title-text-big">
              Segera Berakhir : <br class="d-lg-block d-none" />
              3 bulan premium hanya Rp 49,990
            </h1>
    ...
    <div class="content-3-1 container-xxl mx-auto position-relative" style="font-family: 'Poppins', sans-serif">
      <div class="d-flex flex-lg-row flex-column align-items-center">
        ...
        <div class="right-column d-flex flex-column align-items-lg-start align-items-center text-lg-start text-center">
          <h2 class="title-text">3 Kunci Keuntungan</h2>
          <ul class="p-0 m-0">
            <li class="list-unstyled" style="margin-bottom: 2rem">
              ...
              <p class="text-caption">
                Kita mempunyai fitur untuk mengingatkan tenggat waktu <br class="d-sm-inline d-none" />
                task prioritas.
              </p>
            </li>
            <li class="list-unstyled" style="margin-bottom: 2rem">
              ...
              <p class="text-caption">
                Anda bingung menentukan task prioritas anda ?<br class="d-sm-inline d-none" />
                kami juga menyediakan fitur task urut sesuai prioritas.
              </p>
            </li>
            <li class="list-unstyled" style="margin-bottom: 4rem">
              ...
              <p class="text-caption">
                Kami menyediakan paket hemat untuk anda<br class="d-sm-inline d-none" />
                yang masih sekolah.
              </p>
            </li>
          </ul>
			...
			<div class="list-footer">
				<div class="row gap-md-0 gap-3">
					<div class="col-lg-3 col-md-6">
						<div class="">
							...
							<nav class="list-unstyled">
								...
								<li class="list-space">
									<a href="" class="list-menu">Premium</a>
								</li>
								<li class="list-space">
									<a href="" class="list-menu">Bantuan</a>
								</li>
							</nav>
						</div>
					</div>
					<div class="col-lg-3 col-md-6">
						...
						<nav class="list-unstyled">
							<li class="list-space">
								<a href="" class="list-menu">Statistik</a>
							</li>
							<li class="list-space">
								<a href="" class="list-menu">Mudah Dioperasikan</a>
							</li>
							<li class="list-space">
								<a href="" class="list-menu">Fleksibel</a>
							</li>
							<li class="list-space">
								<a href="" class="list-menu">Riwayat</a>
							</li>
						</nav>
					</div>
					<div class="col-lg-3 col-md-6">
						...
						<nav class="list-unstyled">
							...
							<li class="list-space">
								<a href="" class="list-menu">Keamanan</a>
							</li>
						</nav>
					</div>
					<div class="col-lg-3 col-md-6">
						<h2 class="footer-text-title">Dukungan</h2>
						<nav class="list-unstyled">
							<li class="list-space">
								<a href="" class="list-menu">Mulai</a>
							</li>
							<li class="list-space">
			...
			<div class="border-color info-footer">
				...
				<div class="mx-auto d-flex flex-column flex-lg-row align-items-center footer-info-space gap-4">
					...
					<nav class="mx-auto d-flex flex-wrap align-items-center justify-content-center gap-4">
						<a href="" class="footer-link" style="text-decoration: none">Persyaratan Layanan</a>
						<span>|</span>
						<a href="" class="footer-link" style="text-decoration: none">Kebijakan pribadi</a>
						<span>|</span>
						<a href="" class="footer-link" style="text-decoration: none">Lisensi</a>
					</nav>
					<nav class="d-flex flex-lg-row flex-column align-items-center justify-content-center">
						<p style="margin: 0">Copyright © 2021 Task Management</p>
					</nav>
				</div>
			</div>
		</div>
