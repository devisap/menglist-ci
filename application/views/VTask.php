										...
										<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
											...
											<form id="kt_modal_new_target_form" class="form" action="<?= site_url('task/store')?>" method="post">
												...
												<div class="row g-9 mb-8">
													...
													<div class="col-md-6 fv-row">
														...
														<div class="position-relative d-flex align-items-center">
															...
															<!--end::Icon-->
															<!--begin::Datepicker-->
															<input id="kt_datepicker_3" class="form-control form-control-solid ps-12" placeholder="Select a date" name="due_date" />
															<!--end::Datepicker-->
														</div>
														<!--end::Input-->
													</div>
												...
												<div class="d-flex flex-column mb-8 fv-row">
													...
													<!--end::Label-->
													<input id="kt_tagify_1" class="form-control form-control-solid" value="" name="PENGINGAT_TASK" />
												</div>
												<!--end::Input group-->
												<!--begin::Input group-->
												<div class="d-flex flex-column mb-8 fv-row">
                                                ...
                                                <div class="col-md-6 mb-8 fv-row">
                                                    ...
                                                    <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Select Folder" name="FOLDER_TASK">
...
<script>
	$(document).ready(function(){
		...
		new Tagify(tags1, {
			whitelist: ["5 minutes ahead", "30 minutes ahead", "1 hour ahead", "1 day ahead"],
			maxTags: 10,
			dropdown: {
