...
<body id="kt_body" data-bs-spy="scroll" data-bs-target="#kt_landing_menu" data-bs-offset="200" class="bg-white position-relative">
    ...
    <div class="d-flex flex-column flex-root">
            ...
            <div class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom landing-dark-bg" style="background-image: url(assets/media/svg/landing.svg)">
                ...
                <div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9">
                    ...
                    <div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
                        <!--begin::Title-->
                        <h1 class="text-white lh-base fw-bolder fs-2x fs-lg-3x mb-15">Boost your productivity with
                            <span style="background: linear-gradient(to right, #12CE5D 0%, #FFD80C 100%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">
                                <span id="kt_landing_hero_text">MengList Premium</span>
                            </span>
                        </h1>
        ...
        <div class="modal hide fade" id="mdl_premium">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered mw-600px">
                ...
                <div class="modal-content rounded">
                    ...
                    <div class="modal-header pb-0 border-0 justify-content-between">
                        <h6 class="modal-title text-left fs-1">Upgrade To Premium </h6>
                        <!--begin::Close-->
                        ...
                        <div class="text-center mt-10">
                            <div class="d-flex align-items-center justify-content-center">
                                ...
                                <div class="ms-2">
                                    ...
                                    <!--end::Name-->
                                    <!--begin::Major-->
                                    <span class="text-muted fw-bold d-block fs-7 lh-1">Free User</span>
                                    <!--end::Major-->
                                </div>
                                <!--end::User info-->
                            </div>

                            <h1 class="text-center fs-5 fs-lg-3x mt-5">
                                $120
                            </h1>
                            <label class="text-center fw-bold mb-4 mt-4">Transfer to : </label>
                            <br>Bank BRI : 2066 0101 2672 502
                            <br>
                            <!--begin::Input group-->
                            ...
                            <!--end::Input group-->
                            <button type="submit" id="" class="btn btn-primary mt-10">
    ...
    <script>
        new Dropzone("#kt_modal_create_ticket_attachments", {
            url: "http://localhost/menglist-ci/premium",
            paramName: "file",
            maxFiles: 10,
            maxFilesize: 10,
            addRemoveLinks: !0,
