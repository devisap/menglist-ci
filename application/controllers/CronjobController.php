                            ...
                            <div class="pt-lg-10 mb-10">
                                ...
                                <div class="row justify-content-md-center">
                                    <div class="col-xs-offset-4 col-xs-4">
                                        <h6 class="fw-bolder text-left fs-2 text-gray-800 mb-7 align-item-left">Title</h6>
                                    </div>
                                    <div class="col-xs-offset-4 col-xs-4">
                                ...
                                <div class="row justify-content-md-center">
                                    <div class="col-xs-offset-4 col-xs-4">
                                        <h6 class="fw-bolder text-left fs-2 text-gray-800 mb-7 align-item-left">Date</h6>
                                    </div>
                                    <div class="col-xs-offset-4 col-xs-4">
