...
class CronJobController extends CI_Controller{
    ...
    public function reminderTask(){
        ...
        $currDatePlus   = date('Y-m-d H:i', strtotime("+1 minute", strtotime($currDate)));
        $reminders = $this->General->get('task_reminder', ["REMINDER >= " => $currDate.":00", "REMINDER <= " => $currDatePlus.":00", "STATUS" => '0']);
        print_r($currDate." : ".$currDatePlus);
        print_r($reminders);
        if($reminders != null){
            foreach ($reminders as $item) {
                $task = $this->General->get('task', ['ID_TASK' => $item->ID_TASK]);

                $email['to']        = $item->EMAIL_USER;
                $email['subject']   = 'Reminder Task';
                // $email['message']   = $this->templateReminder($task[0]->NAMA_TASK, $task[0]->DESKRIPSI_TASK, date_format(date_create($task[0]->TGL_TASK), 'j F Y H:i'));
                $email['message']   = $this->template();
            }
                    ...
                    <div class="d-flex flex-column flex-column-fluid text-center p-10 py-lg-15">
                        ...
                        <div class="pt-lg-10 mb-10">
                            ...
                            <div class="text-center mb-10">
                                <a href="https://menglist.bgskr-project.my.id/task" class="btn btn-lg btn-primary fw-bolder">Skip for now</a>
                            </div>
                            <!--end::Action-->
                        </div>
    ...
    public function templateReminder($title, $desc, $date){
        return '
            <!DOCTYPE html>
            <html lang="en">
            <!--begin::Head-->
            ...
            <body id="kt_body" class="bg-body">
                ...
                <div class="d-flex flex-column flex-root">
                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                        ...
                        <div class="d-flex flex-column flex-column-fluid text-center p-10 py-lg-15">
                            <!--begin::Logo-->
                            <a href="'.site_url('task').'" class="mb-10 pt-lg-10">
                                <img alt="Logo" src="https://menglist.bgskr-project.my.id/assets/media/logos/favicon.ico" class="h-40px mb-5" />
                                <img alt="Logo" src="https://menglist.bgskr-project.my.id/assets/media/logos/logo.png" class="h-40px mb-5" />
                            </a>
                            <!--end::Logo-->
                            ...
                            <div class="pt-lg-10 mb-10">
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-xs-offset-4 col-xs-4">
                                        <h1 class="fs-3 fw-bold text-muted mb-10">'.$title.'</h1>
                                    </div>
                                </div>
                                <div class="row justify-content-md-center">
                                    <div class="col-xs-offset-4 col-xs-4">
                                    ...
                                    <div class="col-xs-offset-4 col-xs-4">
                                        <h1 class="fs-3 fw-bold text-muted mb-10">'.$date.'</h1>
                                    </div>
                                </div>
                                <div class="row justify-content-md-center">
                                    <div class="col-xs-offset-4 col-xs-4">
                                    ...
                                    <div class="col-xs-offset-4 col-xs-4">
                                        <h1 class="fs-3 fw-bold text-muted mb-10">'.$desc.'</h1>
                                    </div>
                                </div>
                                <!--begin::Action-->
                                <div class="text-center mb-10">
                                    <a href="'.site_url('task').'" class="btn btn-lg btn-primary fw-bolder">Skip for now</a>
                                </div>
                                <!--end::Action-->
                            </div>
